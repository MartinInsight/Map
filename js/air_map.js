...
class AirCongestionMap {
    ...
    constructor(mapElementId) {
        ...
        this.map.on('click', (e) => {
            ...
            if (this.lastOpenedMarker && this.lastOpenedMarker.getPopup().isOpen()) {
                ...
                //return; // May not be needed due to autoClose:true now
            }
    ...
    getColor(level, isText = false) {
        // These are the colors from the original AirCongestionMap, adapted to the Rail's structure.
        const circleColors = {
            'Very High': '#d73027', // Red
            'High': '#fc8d59',    // Orange
            'Average': '#fee08b', // Yellow
            'Low': '#d9ef8b',     // Light Green
            'Very Low': '#1a9850', // Dark Green
            'Unknown': '#cccccc'  // Grey
        };

        // Text colors adjusted for better contrast with the circle colors.
        const textColors = {
            'Very High': '#a50026', // Darker red
            'High': '#e34a33',    // Darker orange
            'Average': '#fdbe85', // Darker yellow/orange from palette
            'Low': '#a6d96a',     // Darker light green
            'Very Low': '#006837', // Darker dark green
            'Unknown': '#777777'  // Darker grey
        };
...
// Expose RailCongestionMap class to the global scope
